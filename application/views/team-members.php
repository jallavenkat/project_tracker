                  ...
                  ?>
                   <tr>
                    ...
                    <td>
                      ...
                      ?>
                      <?php 
                        echo @$teams[$t]->firstname;
                      if(@$teams[$t]->position == "team-lead" )
                      {
                      ?>
                        <br /><a href="<?php echo base_url()."lead-team/".@$teams[$t]->firstname;?>" class="f12"><i class="bi bi-eye-fill"></i> View Team</a>
                      <?php
                      }
                      ?>
                    </td>
                    ...
                    <td>
                    <a href="<?php echo base_url()."home/memberProjects/".@$teams[$t]->id;?>">
                      <?php echo @sizeOf($teams[$t]->projects);?>
                    </a>
                  </td>
                    <td>
                    <a href="<?php echo base_url()."home/memberTasks/".@$teams[$t]->id;?>">
                      <?php echo @sizeOf($teams[$t]->tasks);?>
                    </a>
                  </td>
                    <td>
                      <a href="<?php echo base_url()."home/editTeamMember/".@$teams[$t]->id;?>" class="f12"><i class="bi bi-pencil-square"></i> Edit</a>
                    </td>
                  </tr>
                  <?php
                    }
